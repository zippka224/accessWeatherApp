...
print("Ažuriranje podataka za svijet")
...
def gradovi():
    url = "http://www.vrijeme.net/svijet"
...
#    cursor.execute("INSERT INTO vrijeme_svijet (grad) VALUES ('{}')".format(grad))
